...
class LogisticRegression(nn.Module):
    ...
    def __init__(self, n_classes, n_features, **kwargs):
        ...
        self.W = nn.Parameter(torch.randn(n_classes, n_features) * 0.01)
...
class FeedforwardNetwork(nn.Module):
    def __init__(
        ...
        # Hidden layers
        for _ in range(layers - 1):  # Add the remaining hidden layers
    ...
    def forward(self, x, **kwargs):
        ...
        for layer in self.layers:
            ...
            # Output layer (no activation applied here; logits are used for loss)
